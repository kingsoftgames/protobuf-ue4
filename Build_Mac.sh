...
# static 
cmake -Dprotobuf_BUILD_SHARED_LIBS=OFF -DCMAKE_OSX_DEPLOYMENT_TARGET=$PROTOBUF_UE4_MACOS_DEPLOYMENT_TARGET -DCMAKE_INSTALL_PREFIX="$PROTOBUF_UE4_PREFIX/build" .
