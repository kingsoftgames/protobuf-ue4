...
void protobuf_RegisterTypes(const ::ue4::string&) GOOGLE_PROTOBUF_ATTRIBUTE_COLD;
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          Struct_FieldsEntry_DoNotUse::Parser< ::google::protobuf::internal::MapField<
              ...
              0 >,
            ::google::protobuf::Map< ::ue4::string, ::google::protobuf::Value > > parser(&fields_);
...
void Struct::SerializeWithCachedSizes(
  ...
  if (!this->fields().empty()) {
    typedef ::google::protobuf::Map< ::ue4::string, ::google::protobuf::Value >::const_pointer
        ConstPtr;
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      typedef ::google::protobuf::Map< ::ue4::string, ::google::protobuf::Value >::size_type size_type;
      size_type n = 0;
      for (::google::protobuf::Map< ::ue4::string, ::google::protobuf::Value >::const_iterator
